...
function Navbar() {
  ...
  return (
    <div>
      <header
        id="header"
        className="transparent-header-modern fixed-header-bg-white w-100"
      >
              ...
              <div className="col-lg-12">
                <nav className="navbar navbar-expand-lg navbar-light p-0">
                  <a className="navbar-brand position-relative" href="/">
                    <img
                      className="nav-logo"
                      src="assets/images/IMG_0926.PNG"
                      alt=""
                      height={30}
                      width={30}
                    />
                  ...
                  >
                    ...
                    {token["token"] != null ? (
                      <>
                        <a className="navig">Profile</a>
                        <a className="navig" onClick={logoutBtn}>
                          Log Out
                        </a>
                      </>
                    ) : (
                      <>
                        <a className="navig" href="/login">
                          Login
                        </a>
                        <a className="navig" href="/register">
                          Register
                        </a>
                      </>
                    )}
