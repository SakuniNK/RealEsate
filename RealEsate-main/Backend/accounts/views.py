...
class CustomUserView(viewsets.ModelViewSet):
    serializer_class = CustomerSerializer(many=True)
...
class CustomUserDetailsView(APIView):
    def get(self, request):
        ...
        # Serialize the data using CustomerSerializer with the required fields
        serializer = CustomerSerializer(users, many=True, fields=['id', 'fullname', 'username', 'email'])
